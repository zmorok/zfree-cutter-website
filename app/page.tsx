...
const copy = {
  ru: {
    ...
    final: {
      eyebrow: "Версия 0.5.4.1 · Android 10+",
  ...
  en: {
    ...
    final: {
      eyebrow: "Version 0.5.4.1 · Android 10+",
  ...
  useEffect(() => {
    ...
    const metadataFrame = window.requestAnimationFrame(() => {
      ...
      if (description) {
        description.content =
          locale === "ru"
            ? "ZFree Cutter 0.5.4.1 — открытый Android-редактор видео, фото и GIF с точным кадрированием и настраиваемым онлайн-поиском."
            : "ZFree Cutter 0.5.4.1 is an open-source Android editor for video, photos, and GIFs with exact cropping and configurable online search.";
      }
    });
        ...
        <div className="final-card">
          <div className="final-copy">
            ...
            <div className="final-links">
              ...
              <a href={`${REPOSITORY_URL}/releases/tag/v0.5.4.1`} target="_blank" rel="noreferrer">{t.final.changelog}</a>
            </div>
          </div>
