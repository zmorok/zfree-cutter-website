...
export const metadata: Metadata = {
  ...
  description:
    "ZFree Cutter 0.6.2 is an open-source Android editor for video, photos, and GIFs with precise video controls, bounded photo resizing, and on-device export.",
  ...
  openGraph: {
    ...
    description: "Version 0.6.2 of the open-source media editor for Android.",
    url: siteUrl,
