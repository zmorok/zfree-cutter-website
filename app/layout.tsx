...
export const metadata: Metadata = {
  ...
  description:
    "ZFree Cutter 0.5.4.1 is an open-source Android editor for video, photos, and GIFs with exact cropping, configurable online media search, and on-device export.",
  ...
  openGraph: {
    ...
    description: "Version 0.5.4.1 of the open-source media editor for Android.",
    url: siteUrl,
