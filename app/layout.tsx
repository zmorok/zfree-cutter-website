...
export const metadata: Metadata = {
  ...
  description:
    "ZFree Cutter 0.5.5 is an open-source Android editor for video, photos, and GIFs with exact cropping, resolution sorting, configurable online media search, and on-device export.",
  ...
  openGraph: {
    ...
    description: "Version 0.5.5 of the open-source media editor for Android.",
    url: siteUrl,
