...
export const metadata: Metadata = {
  ...
  description:
    "ZFree Cutter 0.5.6 is an open-source Android editor for video, photos, and GIFs with compact Telegram animations, exact cropping, and on-device export.",
  ...
  openGraph: {
    ...
    description: "Version 0.5.6 of the open-source media editor for Android.",
    url: siteUrl,
